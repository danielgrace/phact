...
@implementation SwipeLongPressGestureRecognizer
...
@interface SwipeTableViewCell () <UIScrollViewDelegate>
{
...
@property (nonatomic, strong) UtilityButtonView *scrollViewButtonViewLeft;
@property (nonatomic, strong) UtilityButtonView *scrollViewButtonViewRight;
@property (nonatomic, weak) UIView *scrollViewContentView;
@property (nonatomic) CGFloat height;

@property (nonatomic, strong) SwipeLongPressGestureRecognizer *longPressGestureRecognizer;
...
- (void)initializer
{
    ...
    SwipeCellScrollView *cellScrollView = [[SwipeCellScrollView alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.bounds), self.height)];
    ...
    SwipeLongPressGestureRecognizer *longPressGestureRecognizer = [[SwipeLongPressGestureRecognizer alloc] initWithTarget:self
...
- (void)setLeftUtilityButtons:(NSArray *)leftUtilityButtons
{
    ...
    UtilityButtonView *departingLeftButtons = self.scrollViewButtonViewLeft;
    UtilityButtonView *scrollViewButtonViewLeft = [[UtilityButtonView alloc] initWithUtilityButtons:leftUtilityButtons
                                                                                             parentCell:self
...
- (void)setRightUtilityButtons:(NSArray *)rightUtilityButtons
{
    ...
    UtilityButtonView *departingLeftButtons = self.scrollViewButtonViewRight;
    UtilityButtonView *scrollViewButtonViewRight = [[UtilityButtonView alloc] initWithUtilityButtons:rightUtilityButtons
                                                                                              parentCell:self
...
{
    SwipeLongPressGestureRecognizer *longPressGestureRecognizer = (SwipeLongPressGestureRecognizer *)sender;
...
{
    UtilityButtonTapGestureRecognizer *utilityButtonTapGestureRecognizer = (UtilityButtonTapGestureRecognizer *)sender;
...
- (void)scrollToRight:(inout CGPoint *)targetContentOffset
{
    ...
    {
        for (SwipeTableViewCell *cell in [self.containingTableView visibleCells]) {
            if (cell != self && [cell isKindOfClass:[SwipeTableViewCell class]] && [self.delegate swipeableTableViewCellShouldHideUtilityButtonsOnSwipe:cell]) {
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    {
        [self.cellScrollView setContentOffset:CGPointMake(0, 0) animated:NO];
        return;
    }
