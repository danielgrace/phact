...
{    
    ...
    if(![self reachedLastPage]) {
        ...
        [self fetchResultsWithPage:self.page+1 categoryId:self.categoryId pageSize:self.pageSize];
    }
}

#pragma mark - Sublclass methods

- (void)fetchResultsWithPage:(NSInteger)page categoryId:(NSInteger)category pageSize:(NSInteger)pageSize
{
